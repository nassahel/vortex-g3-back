...
import { Chart, ChartConfiguration, ChartType, CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend } from 'chart.js';
...
export class ChartService {
    ...
    async generateChart(
        ...
        options: ChartConfiguration['options'] = { scales: {
            y: {
              ticks: {
                precision: 0 
              }
