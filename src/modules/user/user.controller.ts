...
export class UserController {
  ...
  @ApiResponse({ status: 201, description: SWAGGER_TRANSLATIONS.USER_CREATE_SUCCESS })
  ...
  @ApiResponse({ status: 201, description: SWAGGER_TRANSLATIONS.USER_GET_ALL_SUCCESS })
  findAll() {
  ...
  @ApiResponse({ status: 201, description: SWAGGER_TRANSLATIONS.USER_GET_ONE_SUCCESS })
  ...
  @ApiResponse({ status: 201, description: SWAGGER_TRANSLATIONS.USER_UPDATE_SUCCESS })
  ...
  @ApiResponse({ status: 201, description: SWAGGER_TRANSLATIONS.USER_DELETE_SUCCESS })
