...
export class CartService {
  ...
  async getActiveCart(userId: string): Promise<{ id: string; items: any[] }> {
    //Obtiene el carrito existente, usa los status pending del usuario. En el caso de que no exista, crea uno nuevo.
  ...
  async addItemToCart(
    ...
    //Agrega un producto al carrito o lo actualiza si ya existe.
