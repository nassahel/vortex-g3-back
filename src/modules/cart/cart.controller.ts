import { Controller, Get, Post, Body, Put, Param, Delete, Request, BadRequestException, NotFoundException } from '@nestjs/common';
...
export class CartController {
  ...
  @ApiResponse({ status: 200, description: 'Item added or updated successfully' })
  ...
  async upsertCartItem(
      ...
      try {
          const result = await this.cartService.upsertCartItem(userId, upsertCartItemDto);
